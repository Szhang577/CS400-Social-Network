...
/**
 * Class to construct undirected and unweighed graph. This class inherits interface
 * from GraphADT
 */
public class Graph implements GraphADT {
   ...
   * 
   * Valid argument conditions: 1. neither node is null 2. both nodes are in the graph 3. no edges
   * between two users
   * 
   ...
   * 
   * Valid argument conditions: 1. neither node is null 2. both nodes are in the graph 3. the
